...
import com.myapp.three.domain.JobHistory;
import com.myapp.three.repository.JobHistoryRepository;
import com.myapp.three.service.JobHistoryService;
...
/**
 * REST controller for managing {@link com.myapp.three.domain.JobHistory}.
 */
@RestController
@RequestMapping("/api")
